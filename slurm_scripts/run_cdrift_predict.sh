...
#SBATCH --mem=64G
#SBATCH -t 04:00:00
#SBATCH -o cdrift_predict_%j.log
...
echo "=============================================================="
echo "CV4CDD cdrift Datasets Preprocessing and Prediction"
echo "Date: $(date)"
echo "Host: $(hostname)"
...
python predict.py \
    --model-path /storage/home/deig/nobackup/ARM-based-CV4CDD_backup/outputs/exp_arm_latest/exported_model \
    --image-dir /storage/home/deig/nobackup/cv4cdd/data/cdrift_predictions_arm/winsim_70/winsim_images \
    --encoding winsim \
    --n-windows 70 \
    --output-dir /storage/home/deig/nobackup/cv4cdd/data/cdrift_predictions_arm_arm/winsim_70
