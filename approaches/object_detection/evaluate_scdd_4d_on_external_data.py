...
def main_cp_only_external(full_path, LAG):
    ...
    log_data = pd.read_csv("/work/alexkrau/projects/scdd/data/input_cdrift/log_size_info.csv")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--base-path", dest="base_path", type=str, 
                        default="/work/alexkrau/projects/scdd/data/output/input_cdrift/cv4cdd_4d",
