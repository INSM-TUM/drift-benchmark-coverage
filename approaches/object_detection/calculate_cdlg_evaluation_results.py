...
def evaluate(
    ...
    actual_drifts = extract_drift_info(di_df)

    print("Reading prediction results")
...
if __name__ == "__main__":
    ...
    print(f"  - Prediction results: {args.prediction_results}")
    print(f"  - Drift info: {args.drift_info}")
    print(f"  - Number of traces: {args.number_of_traces}")
