...
BASE_REPRESENTATION = "dfg_io" # Options: 'dfg', 'dfg_io', 'arm'
...
TRAINED_MODEL_PATH = "/work/alexkrau/projects/scdd/data/output/20241021-131500_winsim_sgd"              # all four drift types (model v7) new
